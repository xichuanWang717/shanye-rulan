...
test('entry points use new cache versions for every changed module', async () => {
  ...
  assert.match(index, /world\.js\?v=76/);
  assert.match(index, /process\.css\?v=41/);
  assert.match(index, /language\.js\?v=74/);
  assert.match(world, /flight-transition\.js\?v=43/);
  assert.match(world, /pavilion-flight-path\.js\?v=2/);
  assert.match(world, /pavilion\.js\?v=74/);
