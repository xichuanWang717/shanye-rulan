...
function sync(){caption.textContent=stages[stage][0];next.textContent='自动演示 · '+stages[stage][1];next.hidden=stage===4;panel.querySelector('#batik-zoom').hidden=stage!==4;canvas.hidden=false;image.hidden=true;gestureHint.hidden=stage===4;gestureHint.textContent=['按住布面，向下拖动，让白布入染','按住布面，向上提起，观察空气带出的蓝','轻触布面，放入热水；等待热量融去蜡','清洗后的布，向一侧拖开，展开全幅',''][stage];if(stage===4)showEnding();}
